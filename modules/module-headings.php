...
_x( 'after the deadline, afterthedeadline, spell, spellchecker, spelling, grammar, proofreading, style, language, cliche', 'Additional Search Queries', 'jetpack' );
...
_x( 'gallery, carousel, diaporama, slideshow, images, lightbox, exif, metadata, image', 'Additional Search Queries', 'jetpack' );
...
_x( 'comments, comment, facebook, twitter, google+, social', 'Additional Search Queries', 'jetpack' );
...
_x( 'contact, form, grunion, feedback, submission', 'Additional Search Queries', 'jetpack' );
...
_x( 'cpt, custom post types, portfolio, portfolios, testimonial, testimonials', 'Additional Search Queries', 'jetpack' );
...
_x( 'css, customize, custom, style, editor, less, sass, preprocessor, font, mobile, appearance, theme, stylesheet', 'Additional Search Queries', 'jetpack' );
...
_x( 'google, seo, firehose, search, broadcast, boradcasting', 'Additional Search Queries', 'jetpack' );
...
_x( 'gravatar, hovercards', 'Additional Search Queries', 'jetpack' );
...
_x( 'scroll, infinite, infinite scroll', 'Additional Search Queries', 'jetpack' );
...
_x( 'api, rest, develop, developers, json, klout, oauth', 'Additional Search Queries', 'jetpack' );
...
_x( 'latex, math, equation, equations, formula, code', 'Additional Search Queries', 'jetpack' );
...
_x( 'like, likes, wordpress.com', 'Additional Search Queries', 'jetpack' );
...
_x( 'manage, management, remote', 'Additional Search Queries', 'jetpack' );
...
_x( 'md, markdown', 'Additional Search Queries', 'jetpack' );
...
_x( 'mobile, theme, minileven', 'Additional Search Queries', 'jetpack' );
...
_x( 'monitor, uptime, downtime, monitoring', 'Additional Search Queries', 'jetpack' );
...
_x( 'notification, notifications, toolbar, adminbar, push, comments', 'Additional Search Queries', 'jetpack' );
...
_x( 'search', 'Additional Search Queries', 'jetpack' );
...
_x( 'photon, image, cdn, performance, speed', 'Additional Search Queries', 'jetpack' );
...
_x( 'post by email, email', 'Additional Search Queries', 'jetpack' );
...
_x( 'security, secure, protection, botnet, brute force, protect, login', 'Additional Search Queries', 'jetpack' );
...
_x( 'facebook, twitter, google+, googleplus, google, path, tumblr, linkedin, social, tweet, connections, sharing', 'Additional Search Queries', 'jetpack' );
...
_x( 'related, related posts', 'Additional Search Queries', 'jetpack' );
...
_x( 'share, sharing, sharedaddy, buttons, icons, email, facebook, twitter, google+, linkedin, pinterest, pocket, press this, print, reddit, tumblr', 'Additional Search Queries', 'jetpack' );
...
_x( 'shortcodes, shortcode, embeds, media, bandcamp, blip.tv, dailymotion, digg, facebook, flickr, google calendars, google maps, google+, polldaddy, recipe, recipes, scribd, slideshare, slideshow, slideshows, soundcloud, ted, twitter, vimeo, vine, youtube', 'Additional Search Queries', 'jetpack' );
...
_x( 'shortlinks, wp.me', 'Additional Search Queries', 'jetpack' );

// modules/site-icon.php
_x( 'Site Icon', 'Module Name', 'jetpack' );
_x( 'Add a site icon to your site.', 'Module Description', 'jetpack' );
_x( 'favicon, icon, site icon', 'Additional Search Queries', 'jetpack' );
...
_x( 'sso, single sign on, single, login, log in', 'Additional Search Queries', 'jetpack' );
...
_x( 'statistics, tracking, analytics, views, traffic, stats', 'Additional Search Queries', 'jetpack' );
...
_x( 'subcriptions, subscription, email, follow, followers, subscribers, signup', 'Additional Search Queries', 'jetpack' );
...
_x( 'gallery, tiles, tiled, grid, mosaic, images', 'Additional Search Queries', 'jetpack' );
...
_x( 'vaultpress, backup, security', 'Additional Search Queries', 'jetpack' );
...
_x( 'webmaster, seo, google, bing, pinterest, search, console', 'Additional Search Queries', 'jetpack' );
...
_x( 'video, videos, videopress', 'Additional Search Queries', 'jetpack' );
...
_x( 'widget visibility, logic, conditional, widgets, widget', 'Additional Search Queries', 'jetpack' );
...
_x( 'widget, widgets, box, facebook, gallery, twitter, gravatar, image, rss', 'Additional Search Queries', 'jetpack' );
